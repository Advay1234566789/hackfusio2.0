...
const BookingSystem = () => {
  ...
  return (
    // Outer container now uses a full-height dark gray background
            ...
            <div className="flex space-x-8">
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md ${
                  view === 'dashboard' ? 'bg-blue-100 text-blue-600' : 'text-gray-300'
                }`}
              >
                {/* Uncomment icon and text if desired */}
                {/* <Home size={20} /> */}
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-3 py-2 rounded-md ${
                  view === 'bookings' ? 'bg-blue-100 text-blue-600' : 'text-gray-300'
                }`}
              >
                <BookOpen size={20} />
...
const Dashboard = ({ bookings }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gray-800 rounded shadow p-4 md:col-span-2">
      ...
      <nav className="bg-gray-800 p-4 rounded mb-6">
        <div className="flex space-x-4">
          <button 
            ...
            className={`px-4 py-2 rounded ${clubView === 'dashboard' ? 'bg-blue-600' : 'bg-gray-700'}`}
          >
            Dashboard
          </button>
          <button 
            onClick={() => setClubView('budget')}
            className={`px-4 py-2 rounded ${clubView === 'budget' ? 'bg-blue-600' : 'bg-gray-700'}`}
          >
            Budget
          </button>
          <button 
            onClick={() => setClubView('applications')}
            className={`px-4 py-2 rounded ${clubView === 'applications' ? 'bg-blue-600' : 'bg-gray-700'}`}
          >
            Club Details
          </button>
        </div>
...
function ClubBudget() {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleBudgetSubmit} className="bg-gray-800 text-white p-4 rounded shadow mb-6">
        <div className="mb-4">
          <label>Title</label>
          <input 
            type="text"
