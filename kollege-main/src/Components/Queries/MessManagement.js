...
const BudgetTrackingSystem = () => {
  // State declarations
  const [activeTab, setActiveTab] = useState('dashboard'); // 'dashboard', 'budgets', 'expenses', 'sponsors', 'mess'
  ...
  return (
    // Outer container uses dark theme classes
    <div className="min-h-screen bg-gray-900 text-white p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">College Budget Tracking System</h1>
        {/* Real-Time Notification Banner */}
        {notifications.length > 0 && (
          <div className="mb-4 p-2 bg-green-800 text-green-200 rounded shadow">
            {notifications[0]}
          </div>
        )}
        <div className="bg-gray-800 rounded-lg shadow mb-6">
          ...
          <div className="flex border-b border-gray-700">
            <button
              className={`px-4 py-2 font-medium ${activeTab === 'dashboard' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-300'}`}
            ...
            <button
              className={`px-4 py-2 font-medium ${activeTab === 'budgets' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-300'}`}
            ...
            <button
              className={`px-4 py-2 font-medium ${activeTab === 'expenses' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-300'}`}
            ...
            <button
              className={`px-4 py-2 font-medium ${activeTab === 'sponsors' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-300'}`}
            ...
            <button
              className={`px-4 py-2 font-medium ${activeTab === 'mess' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-300'}`}
          ...
          <div className="p-4">
                  ...
                  <table className="min-w-full">
                    <thead className="bg-gray-700">
                      <tr>
                        ...
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Department</th>
            ...
            {activeTab === 'expenses' && (
              <div>
                <form onSubmit={handleExpenseSubmit} className="mb-6">
                  ...
                  <div className="mt-4">
                    <label className="block text-sm font-medium text-gray-300 mb-1">Proof Files (Optional)</label>
                    <input
                      type="file"
                      multiple
                      className="w-full p-2 border rounded bg-gray-700"
                  ...
                  <table className="min-w-full">
                    <thead className="bg-gray-700">
                      <tr>
                        ...
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Status</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Proofs</th>
                      </tr>
                    </thead>
                    <tbody className="bg-gray-800 divide-y divide-gray-700">
                          ...
                          <td className="px-4 py-2 whitespace-nowrap">
                            {expense.proof_files.map((file, index) => (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-blue-400 hover:text-blue-600 block"
                              >
                                View Proof {index + 1}
                              </a>
                            ))}
              ...
              <div>
                <form onSubmit={handleSponsorSubmit} className="mb-6">
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1">Sponsor Name</label>
                      <input
                        type="text"
                        className="w-full p-2 border rounded bg-gray-700"
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1">POC Name</label>
                      <input
                        type="text"
                        className="w-full p-2 border rounded bg-gray-700"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1">POC Contact</label>
                      <input
                        type="text"
                        className="w-full p-2 border rounded bg-gray-700"
                  ...
                  <div className="mt-4">
                    <label className="block text-sm font-medium text-gray-300 mb-1">Contract Details</label>
                    <textarea
                      className="w-full p-2 border rounded bg-gray-700"
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full">
                    <thead className="bg-gray-700">
                      <tr>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Sponsor Name</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Amount</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Purpose</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase">Status</th>
                      </tr>
                    </thead>
                    <tbody className="bg-gray-800 divide-y divide-gray-700">
            ...
            {activeTab === 'mess' && (
              <div>
                ...
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-300 mb-1">Mess Budget</label>
                  <input
                    type="number"
                    className="w-full p-2 border rounded bg-gray-700"
                    value={messBudget}
